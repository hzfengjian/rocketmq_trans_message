...
public class DispatchRequest {
    ...
    private final long checkImmunityTimeOutTimestamp;
    ...
    public DispatchRequest(
            ...
            final long checkImmunityTimeOutTimestamp
    ) {
        this.topic = topic;
        ...
        this.checkImmunityTimeOutTimestamp = checkImmunityTimeOutTimestamp;
    }
    ...
    public DispatchRequest(int size) {
        ...
        this.producerGroup = "";
        this.checkImmunityTimeOutTimestamp = 0;
    }
    ...
    public long getCheckImmunityTimeOutTimestamp() {
        return checkImmunityTimeOutTimestamp;
    }
}
