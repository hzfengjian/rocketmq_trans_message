...
public class StorePathConfigHelper {
    ...
    public static String getTranOffsetPath(final String rootDir) {
        return rootDir + File.separator + "transaction" + File.separator + "tranOffset";
    }

    public static String getTranTablePath(final String rootDir) {
        return rootDir + File.separator + "transaction" + File.separator + "tranTable";
    }
}
